...
<script src="/ThucHanhWeb2/client/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<link href="/ThucHanhWeb2/client/css/login.css" rel="stylesheet" type="text/css" media="all"/>
<!-- for-mobile-apps -->
			...
			<div class="header-bottom">
				<div class="header-right w3agile">
					...
					<div class="header-left-bottom agileinfo">
					 ...
					 <form action="/ThucHanhWeb2/login-admin" method="post">
					...
					<input type="password"  value="Password" name="matKhau" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'password';}"/>
						<div class="remember">
			             <span class="checkbox1">
							   <label class="checkbox"><input type="checkbox" name="check" checked="checked"><i> </i>Remember me</label>
						 </span>
						 <div class="forgot">
