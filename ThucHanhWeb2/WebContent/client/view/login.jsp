...
<script src="/ThucHanhWeb2/admins/js/jquery.min.js"></script>
<!-- Custom Theme files -->
			...
			<div class="header-bottom">
				<div class="header-right w3agile">
					...
					<div class="header-left-bottom agileinfo">
					 ...
					 <form action="/ThucHanhWeb2/login-client" method="post">
					...
					<div class="header-social wthree">
							...
							<a href="/ThucHanhWeb2/client/dangki" class="twitt"><h5>SignUp</h5></a>
						</div>
