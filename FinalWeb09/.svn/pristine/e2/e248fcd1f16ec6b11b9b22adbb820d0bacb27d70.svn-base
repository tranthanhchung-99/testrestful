...
<body>
	<form action="/FinalWeb09/client/inforclient" method="get"></form>
	<div class="head">
	...
	<div class="main">
		<div class="image">
			<div class="d1">
				<img id="img" src="/FinalWeb09/download?image=${user.imageUrl }"
					alt="#">
			</div>
		</div>
		<div class="txt">
			...
			<div class="button">
				<a
					href="/FinalWeb09/client/updateinfor?id=${sessionScope.loginClient.id }"
					class="btn btn-info" role="button"><i class="fas fa-edit"></i>
					UPDATE</a> <a
					href="/FinalWeb09/client/updatepass?id=${sessionScope.loginClient.id }"
					class="btn btn-info" role="button"><i class="fas fa-marker"></i>
					CHANGEPASS</a>
					<a
